function readText(wb,zj) {
  ...
  if(eachLine!=""){
    ...
    tt.style.cssText="font-family:黑体;background-color:rgb(203,203,203);color:black;padding:30px;border-radius:60px 60px 60px 60px;-webkit-border-radius:60px 60px 60px 60px;-moz-border-radius:60px 60px 60px 60px;";
